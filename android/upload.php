...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $url = "https://febrian001.000webhostapp.com/android/upload/".$originalImgName; //update path as per your directory structure 
        ...
        if(move_uploaded_file($tempName,$folder.$originalImgName)){
                $query = "INSERT INTO `tb_pendaftaran`(`id_pendaftaran`, `id_loker`, `nisn`, `berkas`) VALUES (null,'$loker','$nisn','$url')";
                ...
                if(mysqli_query($con,$query)){
	                 ...
	                 $emparray = array();
	                     ...
	                     while ($row = mysqli_fetch_assoc($result)) {
                                   ...
                                   echo json_encode(array( "status" => "true","message" => "Pendaftaran Berhasil Dilakukan" , "data" => $emparray) );
