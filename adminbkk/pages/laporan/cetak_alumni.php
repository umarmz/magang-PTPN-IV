    ...
    <tbody>
        <tr>       
            ...
            <td style=width:1066px;>
				...
				<b>YAYASAN SMK NU MA'ARIF KUDUS</b><br>
...
<table border="1" style="width: 100%">
	...
	<tbody>
    <?php
            $sql_tampil = "SELECT tb_tracer.id_alumni, tb_peserta.nisn, tb_peserta.nama, tb_sekolah.id_sekolah, tb_sekolah.nama_sekolah, status, nama_instansi, tb_peserta.tahun_lulus FROM tb_tracer, tb_peserta, tb_sekolah WHERE tb_tracer.nisn=tb_peserta.nisn AND tb_peserta.id_sekolah=tb_sekolah.id_sekolah AND tb_sekolah.id_sekolah='$data_username' AND tb_tracer.status='Bekerja' ORDER BY id_alumni ASC";
