...
<div class="row">
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <!--FORM MODAL-->
										<form class="form-horizontal" method="post" action="./pages/laporan/cetak_alumni_s.php" enctype="multipart/form-data" target="_blank">
											<fieldset>
    ...
    <option value="<?php echo $x ?>"><?php echo $x ?></option>
                    ...
                    <a href="./pages/laporan/cetak_alumni.php" class="btn btn-primary"target="_blank"><i class="fa fa-fw fa-print"></i> Cetak Semua</a>
                    </div>
                </form>
...
<div id="grafik" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Pilihan Grafik</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
                <form action="?halaman=laporan_chart" method="post" enctype="multipart/form-data">
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" name="btnCetak">Tampilkan</button>
                    </div>
                </form>
                <form action="?halaman=laporan_chart" method="post" enctype="multipart/form-data">
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="btnCetakSemua">Tampilkan semua</button>
                    </div>
                </form>
        </div>
    </div>     
            ...
            $tahun = $_POST['tahun'];
            if($tahun != ''){
            $sql_tampil = mysqli_query($con,"SELECT tb_tracer.id_alumni, tb_peserta.nisn, tb_peserta.nama, tb_sekolah.id_sekolah, tb_sekolah.nama_sekolah, status, nama_instansi, tb_peserta.tahun_lulus FROM tb_tracer, tb_peserta, tb_sekolah WHERE tb_tracer.nisn=tb_peserta.nisn AND tb_peserta.id_sekolah=tb_sekolah.id_sekolah AND tb_tracer.status='Studi' AND tb_sekolah.id_sekolah LIKE'".$query."' AND tb_peserta.tahun_lulus=$tahun ORDER BY id_alumni ASC");
            }else{
                                ...
                                <div class="modal fade" id="cetak" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <!--FORM MODAL-->
										<form class="form-horizontal" method="post" action="?halaman=cetak_studi" enctype="multipart/form-data" target="_blank">
											<fieldset>
											<div class="input-group">
											<input type="text" value="<?php echo $row['id_user']; ?>"  name="id_user" id="id_user" hidden> 
											</div>
...
<!--END FORM MODAL-->
            ...
            if($tahun != ''){
            $sql_tampil = mysqli_query($con,"SELECT tb_tracer.id_alumni, tb_peserta.nisn, tb_peserta.nama, tb_sekolah.id_sekolah, tb_sekolah.nama_sekolah, status, nama_instansi, tb_peserta.tahun_lulus FROM tb_tracer, tb_peserta, tb_sekolah WHERE tb_tracer.nisn=tb_peserta.nisn AND tb_peserta.id_sekolah=tb_sekolah.id_sekolah AND tb_sekolah.id_sekolah='$data_username' AND tb_tracer.status='Studi' AND tb_peserta.tahun_lulus=$tahun ORDER BY id_alumni ASC");
            }else{
            $sql_tampil = mysqli_query($con,"SELECT tb_tracer.id_alumni, tb_peserta.nisn, tb_peserta.nama, tb_sekolah.nama_sekolah, status, nama_instansi, tb_peserta.tahun_lulus FROM tb_tracer, tb_peserta, tb_sekolah WHERE tb_tracer.nisn=tb_peserta.nisn AND tb_peserta.id_sekolah=tb_sekolah.id_sekolah AND tb_sekolah.id_sekolah='$data_username' AND tb_tracer.status='Studi' ORDER BY id_alumni DESC");		
            }             
            while($data = mysqli_fetch_array($sql_tampil)){
